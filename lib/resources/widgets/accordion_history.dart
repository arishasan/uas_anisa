                  ...
                  children: [
                    ...
                    Flexible(
                      child: Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(getDateIndo(globalHistoryKeranjang[widget.index].date), style: GoogleFonts.aBeeZee(
                            fontSize: 15.sp,
                    ...
                    SizedBox(width: 20,),
                    Text(globalHistoryKeranjang[widget.index].products.length.toString() + " item", style: GoogleFonts.aBeeZee(
                        fontSize: 15.sp,
                        color: Colors.black.withOpacity(0.8),
                        fontWeight: FontWeight.bold
                      ),),
